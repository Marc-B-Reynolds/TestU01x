 ...
 */
{
  sres_InitBasic (res->JumpNum, N,       "scomp_LinearComp:   Number of Jumps");
  sres_InitChi2 (res->JumpSize, N, jmax, "scomp_LinearComp:   Size of Jumps");
  sres_InitChi2 (res->LinComp,  N, tmax, "scomp_LinearComp:   Linear Complexity");
}
